					...
					<div className="row justify-content-between align-items-center">
							<div className="col-md-4">
								<div className="selectLocation">
									<form action="">
										<select class="form-select mb-3 ps-1 text-uppercase" defaultValue={'DEFAULT'} aria-label="Default select example">
											<option value="DEFAULT" className='option text-dark'>Select Division</option>
										...
										<select class="form-select mb-3 ps-1 text-uppercase" defaultValue={'DEFAULT'} aria-label="Default select example">
											<option value="DEFAULT" className='text-dark'>Select District</option>
